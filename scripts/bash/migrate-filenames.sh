...
declare -A FILE_MAPPING=(
    ...
    ["ai-playbook-assessment.md"]="AIGA"   # Legacy name mapped to AU governance assessment
    ["ai-governance-assessment.md"]="AIGA"
    ["ai-use-case-register.md"]="AIUR"
    ["atrs-record.md"]="AITS"              # Legacy name mapped to AU transparency statement
    ["ai-transparency-statement.md"]="AITS"
    ["ai-impact-assessment.md"]="AIIA"
    ["ai-governance-checklist.md"]="AIGC"
