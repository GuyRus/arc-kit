...
9. **Write outputs**:
   - `projects/{project-dir}/reviews/ARC-{PROJECT_ID}-DLDR-v1.0.md` - Full review report (authoritative record)
   - If a vendor is in scope: optionally also save a copy/link under `projects/{project-dir}/vendors/{vendor}/reviews/ARC-{PROJECT_ID}-DLDR-v1.0.md`
...
- Write to `projects/001-payment-gateway/reviews/ARC-001-DLDR-v1.0.md` (and optionally `projects/001-payment-gateway/vendors/acme-payment-solutions/reviews/ARC-001-DLDR-v1.0.md`)
