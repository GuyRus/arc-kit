...
2. **Read Available Documents**:
   ...
   **OPTIONAL** (read if available, skip silently if missing):
   - `ARC-*-TCOP-*.md` in `projects/{project-dir}/` — Digital Service Standard / Digital Experience policy assessment (where applicable)
     - Extract: Service/policy assessment findings relevant to the design review (e.g., open standards, reliability, security expectations)
...
8. **Write outputs**:
   - `projects/{project-dir}/reviews/ARC-{PROJECT_ID}-HLDR-v1.0.md` - Full review report (authoritative record)
   - If a vendor is in scope: optionally also save a copy/link under `projects/{project-dir}/vendors/{vendor}/reviews/ARC-{PROJECT_ID}-HLDR-v1.0.md`
   - If comparing multiple vendors: `projects/{project-dir}/reviews/ARC-{PROJECT_ID}-HLDR-SUM-v1.0.md` - Summary comparison
...
- Write to `projects/001-payment-gateway/reviews/ARC-001-HLDR-v1.0.md` (and optionally `projects/001-payment-gateway/vendors/acme-payment-solutions/reviews/ARC-001-HLDR-v1.0.md`)
