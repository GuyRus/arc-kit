...
- Read `.arckit/templates/datascout-template.md` for the required output structure
- Read `.arckit/VERSION` for the ArcKit version
...
```bash
DOC_ID=$(.arckit/scripts/bash/generate-document-id.sh {project_id} DSCT ${VERSION})
```
