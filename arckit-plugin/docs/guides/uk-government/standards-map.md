...
flowchart TD
    ...
    UKG_SECURE_BY_DESIGN --> PIA["Privacy Impact Assessment (UK GDPR)"]
...
| **Alpha** | Service Standard (Points 1–7), Technology Code of Practice (baseline), Spend Controls gating, Secure by Design (context) | Alpha assessment pack, architecture principles, PIA screening, sourcing strategy |
